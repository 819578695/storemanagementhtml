...
=======
        ...
        <div class="head-container">
          <!-- 搜索  -->
          <el-date-picker v-model="query.createDateStart" clearable type="date" placeholder="选择日期" style="width:150px;" class="filter-item"/>&nbsp;-
          <el-date-picker v-model="query.createDateEnd" clearable type="date" placeholder="选择日期" style="width:150px;" class="filter-item"/>
          <el-input v-model="query.houseNumber" clearable clearable placeholder="输入档口编号" style="width: 130px;" class="filter-item" />
          ...
          <el-select v-model="query.type" clearable clearable placeholder="请选择类型" class="filter-item" style="width:130px;">
            <el-option
              v-for="(item, index) in dictMap.pevenue_status"
              :key="item.index"
              :label="item.label"
        ...
        <el-pagination
          ...
          @size-change="sizeChange"
          @current-change="pageChange"/>
>>>>>>> 46ca2e7c0ae55ff969faa4cc6720523042167cf9
      </el-col>
    </el-row>
  </div>
</template>
